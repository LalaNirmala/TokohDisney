...
public class GridView extends RecyclerView.Adapter<GridView.GridViewHolder> {
    ...
    public GridView(Context mContext,ArrayList<String> mImageNames, ArrayList<String> mImages, ArrayList<String> mImageDesc , ArrayList<String> mImageLoc ) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_grid_tokohdisney, parent, false);
