...
public class ListView extends RecyclerView.Adapter<ListView.ViewHolder> {
    ...
    public ListView(Context mContext,ArrayList<String> mImageNames, ArrayList<String> mImages, ArrayList<String> mImageDesc , ArrayList<String> mImageLoc ) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_tokohdisney,parent,false);
